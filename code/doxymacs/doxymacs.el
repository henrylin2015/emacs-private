...
(defcustom doxymacs-external-xml-parser-executable
  "/Users/xiaolin/bin/doxymacs_parser"
...
(defconst doxymacs-JavaDoc-file-comment-template
 '("/**" > n
   ...
   (if (buffer-file-name)
     ...
     "") > n
   " * " (doxymacs-doxygen-command-char) "author: henry" > n
   " * " (doxymacs-doxygen-command-char) "time: " (current-time-string) > n
   " * " (doxymacs-doxygen-command-char) " 继承医药 " > n
   " */" > n)
...
(defconst doxymacs-C++-file-comment-template
 '("///" > n
   ...
   (if (buffer-file-name)
       (file-name-nondirectory (buffer-file-name))
     "") > n
   "/// " (doxymacs-doxygen-command-char) "author: henry cpp "
   > n
   "/// " (doxymacs-doxygen-command-char) "date   " (current-time-string) > n
   "/// " > n
   "/// " (doxymacs-doxygen-command-char) "brief  " (p "Brief description of this file: ") > n
 ...
 '((let ((next-func (doxymacs-find-next-func)))
	 ...
	 (list
	  ...
	  (unless (string-match
		...
		"return [type] [description]" (p "Returns: ") > n))
	  " */" '>)
       (progn
...
(defconst doxymacs-Qt-function-comment-template
 '((let ((next-func (doxymacs-find-next-func)))
	 ...
	 (list
	  ...
	  "/*! " '> 'n
	  " " '> 'n
	  " " (doxymacs-doxygen-command-char) " java2"
	  (doxymacs-parm-tempo-element (cdr (assoc 'args next-func)))
	  (unless (string-match
                   (regexp-quote (cdr (assoc 'return next-func)))
                   doxymacs-void-types)
...
(defconst doxymacs-C++-function-comment-template
 '((let ((next-func (doxymacs-find-next-func)))
	 ...
	 (list
	  ...
	  "/// " 'p '> 'n
	  "///" '> 'n
	  " " (doxymacs-doxygen-command-char) " java3"
	  (doxymacs-parm-tempo-element (cdr (assoc 'args next-func)))
	  (unless (string-match
                   (regexp-quote (cdr (assoc 'return next-func)))
                   doxymacs-void-types)
